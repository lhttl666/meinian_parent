...
public class QiniuUtils {
    ...
    public  static String accessKey = "arf2-Kcok2yC5LyDd0A7lu-bGxuVpidDH8GOtkz4";
    public  static String secretKey = "vHzs8Rv0DL2W0so-gV1tcpGCMzg2ih0zI7N9gMsc";
    public  static String bucket = "meinianqn";
